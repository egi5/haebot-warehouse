...
<main class="p-md-3 p-2">
    ...
    <div class="d-flex mb-0">
        <div class="me-auto mb-1">
            <h3 style="color: #566573;">Data Stok Produk</h3>
        </div>
...
<script>
    ...
    function confirm_delete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete').attr('action', '<?= site_url() ?>stockopname/' + id);
                $('#form_delete').submit();
            }
        })
    }
    ...
    function showModalEdit(id) {
        $.ajax({
            type: 'GET',
            url: '<?= site_url() ?>stockopname/' + id + '/edit',
            dataType: 'json',
            success: function(res) {
                if (res.data) {
                    $('#isiForm').html(res.data)
