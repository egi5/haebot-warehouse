<form autocomplete="off" class="row g-3 mt-2" action="<?= site_url() ?>pemesanan" method="POST" id="form">
    ...
    <div class="text-center mb-3">
        <button id="tombolSimpan" class="btn px-5 btn-outline-primary" type="submit">Cari <i class="fa-fw fa-solid fa-arrow-right"></i></button>
    </div>
</form>
